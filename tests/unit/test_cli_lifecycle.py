...
@patch("homelab_gitops.cli.core_commands.status.ReadOnlyProviderFactory")
...
def test_cli_status(mock_yaml, mock_open, mock_exists, mock_listdir, mock_profile, mock_factory, app):
    """Test status command."""
    mock_factory.return_value.status_service.return_value.get_fleet_status.return_value = [
